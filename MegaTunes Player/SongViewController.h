...
@interface SongViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, InfoTabBarControllerDelegate, MPMediaPickerControllerDelegate, UISearchControllerDelegate, MediaGroupViewControllerDelegate, MediaGroupCarouselViewControllerDelegate> {
