...
#define kDefaultLabelBufferSpace 0
#define kDefaultPixelsPerSecond 0
...
- (void)scrollLabelIfNeeded
{
	...
	_isScrolling = YES;
    BOOL doScrollLeft = (self.scrollDirection == ScrollDirectionLeft);
